...
class Images(models.Model):
    image = models.ImageField(upload_to='image/', verbose_name='Общие изображения товаров', blank=True, null=True)
...
class Videos(models.Model):
    video = models.FileField(upload_to='video/', verbose_name='Общие видео товаров', blank=True, null=True)
...
class Product(models.Model):
    ...
    choices = models.ManyToManyField(Choices, blank=True,
                                     verbose_name='Разновидности подкатегории',
