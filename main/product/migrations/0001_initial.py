...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('image', models.ImageField(blank=True, null=True, upload_to='image/', verbose_name='Общие изображения товаров')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('video', models.ImageField(blank=True, null=True, upload_to='video/', verbose_name='Общие изображения товаров')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('choice_cat', models.CharField(blank=True, max_length=155, null=True, verbose_name='Название товара')),
                ...
                ('choices', models.ManyToManyField(blank=True, related_name='item_as_choice', to='product.choices', verbose_name='Название подкатегории')),
                ('images', models.ManyToManyField(blank=True, related_name='images', to='product.images', verbose_name='Все изображения товара')),
                ...
                ('videos', models.ManyToManyField(blank=True, related_name='videos', to='product.images', verbose_name='Все изображения товара')),
            ],
            options={
                'verbose_name': 'Товар',
